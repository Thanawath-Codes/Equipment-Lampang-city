...
<head>
    ...
    <title>EQUIP | Search Equipment Tablet.</title>
    <!--MATERIAL ICONS CDN-->
...
<body>
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="add_equipment_lampangcity">
                ...
                <div class="content">
                <form id="search_form" action="../../../../system/libraries/UData_tablet.php" method="get">
                            ...
                            <div class="column">
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="tablet_brand" name="tablet_brand">
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($tablet_brand_qry)): ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="tablet_speed" name="tablet_speed">
                                        <option selected disabled>เลือก ความเร็ว</option>
                                    </select>
                                </div>
                                <div class="select-box">
                                    <select class="form-select" id="tablet_ram" name="tablet_ram">
                                        <option selected disabled>เลือก ความจุข้อมูลแรม</option>
                                    </select>
                                </div>
                                <div class="select-box">
                                    <select class="form-select" id="tablet_rom" name="tablet_rom">
                                        <option selected disabled>เลือก ความจุข้อมูลรอม</option>
                                    </select>
                                </div>
                                <div class="select-box">
                    ...
                    <script>
                        ...
                        $('#search-form').on('submit', function (e) {
                            ...
                            $.ajax({
                                url: '../../../system/libraries/Searches_tablet.php',  // หน้าแสดงผล
                                type: 'GET',
        ...
        <section class="right">
            <div class="investments">
                <div class="header">
                    <h2>แบรนด์แทบเล็ต</h2>
                    <a href="../Equip_tablet.php">เพิ่มเติม <span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
    ...
    <script src="../../../../assets/js/tablet/db_tablet.js"></script>
