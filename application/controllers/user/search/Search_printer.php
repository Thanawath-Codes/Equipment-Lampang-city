...
<head>
    ...
    <title>EQUIP | Searach Equipment Printer.</title>
    <!--MATERIAL ICONS CDN-->
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="add_equipment_lampangcity">
                ...
                <div class="content">
                <form id="search_form" action="../../../../system/libraries/UData_printer.php" method="get">
                        ...
                        <div class="notification_message">
                            <p>
                                ...
                                กรอกเลขครุภัณฑ์ภัณฑ์ปริ้นท์เตอร์ ตัวอย่าง 892-41-4564.
                            </p>
                        </div>
                            ...
                            <div class="column">
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="printer_brand" name="printer_brand">
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($printer_brand_qry)): ?>
                            ...
                            <div class="column">
                                <div class="select-box">
                                    <select class="select-box" id="status_equipment" name="status_equipment">
                                        <option selected disabled>เลือกสถานะครุภัณฑ์</option>
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    ...
                                    <label for="owner_printer">ชื่อผู้ใช้งานครุภัณฑ์ปริ้นท์เตอร์</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        ...
                        $('#search-form').on('submit', function (e) {
                            ...
                            $.ajax({
                                url: '../../../system/libraries/Data_printer.php',  // หน้าแสดงผล
                                type: 'GET',
         ...
         <section class="right">
            <div class="investments">
                <div class="header">
                    ...
                    <a href="../Equip_printer.php">เพิ่มเติม<span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
