...
<head>
    ...
    <title>EQUIP | Search Equipment UPS.</title>
    <!--MATERIAL ICONS CDN-->
...
<body>
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="add_equipment_lampangcity">
                ...
                <div class="content">
                    <form id="search_form" action="../../../../system/libraries/UData_ups.php" method="get">
                            ...
                            <div class="column">
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="ups_brand" name="ups_brand">
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($ups_brand_qry)): ?>
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    <input type="text" name="owner_ups"/>
                        ...
                        <div class="notification_message">
                            <p>
                                <span class="material-icons-sharp">error</span>
                                กรอกชื่อเจ้าของครุภัณฑ์ ตัวอย่าง นางสาวชปรางทิพย์ บงกชรัตนา.
                            </p>
                        </div>
                    ...
                    <script>
                        ...
                        $('#search-form').on('submit', function (e) {
                            ...
                            $.ajax({
                                url: '../../../system/libraries/Searches_ups.php',  // หน้าแสดงผล
                                type: 'GET',
        ...
        <section class="right">
            <div class="investments">
                <div class="header">
                    ...
                    <a href="../Equip_ups.php">เพิ่มเติม<span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
    ...
    <script src="../../../../assets/js/ups/db_ups.js"></script>
