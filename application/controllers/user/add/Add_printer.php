...
<head>
    ...
    <title>EQUIP | Add Equipment Printer.</title>
    <!--MATERIAL ICONS CDN-->
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="add_equipment_lampangcity">
                ...
                <div class="content">
                    <form action="../../../../system/libraries/insert_printer.php" method="post">
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    <input type="text" name="owner_printer" required />
        ...
        <section class="right">
            <div class="investments">
                <div class="header">
                    ...
                    <a href="../search/Search_printer.php">เพิ่มเติม<span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
