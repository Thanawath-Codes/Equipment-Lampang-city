...
$sql = "SELECT * FROM `ups_lists` WHERE id = $id";
...
if (isset($_POST["submit"])) {
    ...
    $ups_brand = !empty($_POST['ups_brand']) ? $_POST['ups_brand'] : $row['ups_brand'];
    $ups_model = !empty($_POST['ups_model']) ? $_POST['ups_model'] : $row['ups_model'];
    $electrical_capacity = !empty($_POST['electrical_capacity']) ? $_POST['electrical_capacity'] : $row['electrical_capacity'];
    ...
    $owner_ups = !empty($_POST['owner_ups']) ? $_POST['owner_ups'] : $row['owner_ups'];

    // Update data in the database
    $sql = "UPDATE `ups_lists` SET
    ...
    if ($result) {
        header("Location: ../../../../system/messages/equipment/Complete_ups.php?msg=Data updated successfully");
    } else {
...
<head>
    ...
    <title>EQUIP | Update Equipment UPS.</title>
    <!--MATERIAL ICONS CDN-->
...
<body>
    ...
    <main>
        ...
        <?php
        $sql = "SELECT * FROM `ups_lists` WHERE id = $id LIMIT 1";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        ?>
                    ...
                    <form action="" method="post">
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    ...
                                    <label for="first_name">เลขครุภัณฑ์ภัณฑ์เครื่องสำรองไฟ</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="notification_message">
                            <p>
                                ...
                                กรอกเลขครุภัณฑ์ภัณฑ์เครื่องสำรองไฟ ตัวอย่าง 287-40-9358.
                            </p>
                        </div>
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                ...
                                $ups_brand = "SELECT * FROM ups_brands";
                                $ups_brand_qry = mysqli_query($conn, $ups_brand);
                                ?>

                                <div class="select-box">
                                    <select class="form-select" id="ups_brand" name="ups_brand">
                                        <option selected disabled>เลือก แบรนด์เครื่องสำรองไฟ</option>
                                        <?php while ($ups_brand_row = mysqli_fetch_assoc($ups_brand_qry)): ?>
                                        <option value="<?php echo $ups_brand_row['id']; ?>" <?php if ($ups_brand_row['id'] == $row['ups_brand'])
                                               echo 'selected'; ?>>
                                            <?php echo $ups_brand_row['name']; ?>
                                        </option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                                <div class="select-box">
                                    <select class="form-select" id="ups_model" name="ups_model">
                                        <option selected disabled>เลือก รุ่น/โมเดล</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก monitor_brand แล้วหรือยัง
                                        if (!empty($row['ups_brand'])) {
                                            $ups_model_qry = mysqli_query($conn, "SELECT * FROM ups_models WHERE ups_brand_id = {$row['ups_brand']}");
                                            while ($ups_model_row = mysqli_fetch_assoc($ups_model_qry)): ?>
                                        <option value="<?php echo $ups_model_row['id']; ?>" <?php if ($ups_model_row['id'] == $row['ups_model'])
                                               echo 'selected'; ?>>
                                            <?php echo $ups_model_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="electrical_capacity" name="electrical_capacity">
                                        <option selected disabled>เลือก กำลังการผลิตไฟฟ้า</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก ups_model แล้วหรือยัง
                                        if (!empty($row['ups_model'])) {
                                            $electrical_capacity_qry = mysqli_query($conn, "SELECT * FROM electrical_capacitys WHERE ups_model_id = {$row['ups_model']}");
                                            while ($electrical_capacity_row = mysqli_fetch_assoc($electrical_capacity_qry)): ?>
                                        <option value="<?php echo $electrical_capacity_row['id']; ?>" <?php if ($electrical_capacity_row['id'] == $row['electrical_capacity'])
                                               echo 'selected'; ?>>
                                            <?php echo $electrical_capacity_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                            ...
                            <div class="column">
                                <div class="select-box">
                                    <select class="select-box" id="status_equipment" name="status_equipment">
                                        <option selected disabled>เลือกสถานะเครื่องสำรองไฟ</option>
                        ...
                        <div class="department_lampangcity" id="update_department">
                            ...
                            <div class="equipment_lampangcity">
                                <div class="column">
                                    <div class="input-field">
                                        <input type="text" name="owner_ups" value="<?php echo $row['owner_ups'] ?>"
                                            required />
                                        <label for="owner_ups">ชื่อผู้ใช้งานครุภัณฑ์เครื่องสำรองไฟ</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wrapper">
                                <div class="btns">
                                    ...
                                    <div class="back_page">
                                        <div class="btn_back">
                                            <a href="../Equip_ups.php">ย้อนกลับ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="./js/year_equipment.js"></script>

    <script src="./js/connect_database_ups.js"></script>
    <script src="./js/connect_list.js"></script>
