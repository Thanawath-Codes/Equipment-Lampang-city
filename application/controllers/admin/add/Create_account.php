...
<head>
    ...
    <title>EQUIP | Create Account.</title>
    <!--MATERIAL ICONS CDN-->
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="admin_registration">
                ...
                <div class="content">
                    <form action="../../../../system/libraries/created_account.php" method="post">
                        <div class="user-details">
                            <div class="input-box">
                                <span class="details">ชื่อ</span>
                                <input type="text" name="first_name" placeholder="กรอกชื่อของผู้ใช้งาน" required>
                            </div>
                            <div class="input-box">
                                <span class="details">นามสกุล</span>
                                <input type="text" name="last_name" placeholder="กรอกนามสกุลของผู้ใช้งาน" required>
                            </div>

                            <div class="input-box">
                                <span class="details">อีเมล์</span>
                                <input type="text" name="email_address" placeholder="กรอกที่อยู่อีเมลของผู้ใช้งาน" required>
                            </div>
                            <div class="input-box">
                                <span class="details">เบอร์โทร</span>
                                <input type="text" name="phone" id="phone" maxlength="12"
                                    placeholder="กรอกหมายเลขโทรศัพท์ของผู้ใช้งาน" required>
                            </div>
                        </div>
                        ...
                        <div class="user_role">
                            <div class="title">สิทธิ์ผู้ใช้</div>
                        ...
                        <div class="title">สร้างบัญชี</div>
                        <div class="user-details">
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="password" name="password_hash" placeholder="กรอกรหัสผ่านของผู้ใช้งาน"
