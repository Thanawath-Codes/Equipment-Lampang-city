...
<head>
    ...
    <title>EQUIP | Add Equipment Tablet.</title>
    <!--MATERIAL ICONS CDN-->
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="add_equipment_lampangcity">
                ...
                <div class="content">
                    <form action="../../../../system/libraries/insert_tablet.php" method="post">
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                ...
                                <div class="input-field">
                                    <input type="text" name="imei_number" id="imei_number" maxlength="17" required>
                        ...
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    <input type="text" name="owner_tablet" required />
