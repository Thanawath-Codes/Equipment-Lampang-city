...
<head>
    ...
    <title>EQUIP | Equipment Computer.</title>
    <!--MATERIAL ICONS CDN-->
...
<body>
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="wrapper">
                <div class="btns">
                    <a href="../admin/Add/Add_computer.php">เพิ่มข้อมูลผู้ใช้งาน</a>
            ...
            <div class="content_wrapper">
                ...
                <a href="Equip_computers.php" id="next_page" class="material-icons-sharp">
                    arrow_forward_ios
                </a>
            </div>
        ...
        <script>
            ...
            function loadMoreData() {
                ...
                xhr.open('GET', `../../config/load/conn_computer.php?start=${start}&limit=${limit}`, true);
                xhr.onload = function () {
                    if (this.status === 200) {
                        ...
                        <td class="computer_type">${item.computer_type_name}</td>
                        <td class="computer_case">${item.computer_case_name}</td>
                        <td class="computer_model">${item.computer_model_name}</td>
                        <td class="brand_cpu">${item.brand_cpu_name}</td>
                        <td class="spec_cpu">${item.spec_cpu_name}</td>
                        <td class="speed_cpu">${item.speed_cpu}</td>
                        <td class="storage_device">${item.storage_device_name}</td>
                        <td class="storage_spec">${item.storage_spec_name}</td>
                        <td>
                        ...
                        <td>
                            <a href="../../../system/libraries/delete_computer.php?id=${item.id}">
