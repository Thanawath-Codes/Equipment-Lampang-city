...
<head>
    ...
    <title>EQUIP | Equipment UPS.</title>
    <!--MATERIAL ICONS CDN-->
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    <!--STYLESHEET-->
    <link rel="stylesheet" href="../../../assets/css/equip_ups.css">
...
<body>
    <nav>
        <div class="container">
            ...
            <div class="search-bar">
                ...
                <a href="search/Search_ups.php">ค้นหา...</a>
            </div>
    ...
    <main>
        ...
        <section class="middle">
            <div class="header">
                <h1>ครุภัณฑ์เครื่องสำรองไฟ</h1>
            </div>
            <div class="wrapper">
                <div class="btns">
                    <a href="../admin/add/Add_ups.php">เพิ่มข้อมูลผู้ใช้งาน</a>
                    <a href="../../../system/database/download/export_ups.php">ดาวน์โหลดข้อมูล</a>
                </div>
            </div>
        ...
        <script>
            let start = 0;
            const limit = 10;
            const container = document.querySelector('#ups_list_container tbody');
            ...
            function loadMoreData() {
                ...
                xhr.open('GET', `../../config/load/conn_ups.php?start=${start}&limit=${limit}`, true);
                xhr.onload = function () {
                    if (this.status === 200) {
                        ...
                        <td class="ups_brand">${item.ups_brand_name}</td>
                        <td class="ups_model">${item.ups_model_name}</td>
                        <td class="electrical_capacity">${item.electrical_capacity_name}</td>
                        ...
                        <td class="department">${item.department_name}</td>
                            ...
                            <td class="owner_monitor">${item.owner_ups}</td>
                            <td class="created_at">${item.created_at}</td>
                        <td>
                            <a href="update/Update_ups.php?id=${item.id}">
                                <span class="material-icons-sharp">drive_file_rename_outline</span>
                            </a>
                        </td>
                        <td>
                            <a href="../../../system/libraries/delete_ups.php?id=${item.id}">
            ...
            document.querySelector('#ups_list_container').addEventListener('scroll', () => {
                const containerElement = document.querySelector('#ups_list_container');
