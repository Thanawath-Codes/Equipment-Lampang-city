...
$sql = "SELECT * FROM `printer_lists` WHERE id = $id";
...
if (isset($_POST["submit"])) {
    ...
    $year_equipment = isset($_POST['year_equipment']) ? $_POST['year_equipment'] : $row['year_equipment'];
    $printer_brand = isset($_POST['printer_brand']) ? $_POST['printer_brand'] : $row['printer_brand'];
    $printer_model = isset($_POST['printer_model']) ? $_POST['printer_model'] : $row['printer_model'];
    $printer_type = isset($_POST['printer_type']) ? $_POST['printer_type'] : $row['printer_type'];
    $printer_kind = isset($_POST['printer_kind']) ? $_POST['printer_kind'] : $row['printer_kind'];
    $connecting_printer = isset($_POST['connecting_printer']) ? $_POST['connecting_printer'] : $row['connecting_printer'];
    $color_printing = isset($_POST['color_printing']) ? $_POST['color_printing'] : $row['color_printing'];
    $paper_size_printing = isset($_POST['paper_size_printing']) ? $_POST['paper_size_printing'] : $row['paper_size_printing'];
    $status_equipment = isset($_POST['status_equipment']) ? $_POST['status_equipment'] : $row['status_equipment'];
    ...
    $owner_printer = !empty($_POST['owner_printer']) ? $_POST['owner_printer'] : $row['owner_printer'];

    // Update data in the database
    $sql = "UPDATE `printer_lists` SET
        ...
        `paper_size_printing`='$paper_size_printing',
        `status_equipment`='$status_equipment',
        `department`='$department',
        `segment`='$segment',
        `division`='$division',
        `working`='$working',
        `owner_printer`='$owner_printer' WHERE id = $id";


    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: ../../../../system/messages/equipment/Complete_printer.php?msg=Data updated successfully");
    } else {
...
<head>
    ...
    <title>EQUIP | Update Equipment Printer.</title>
    <!--MATERIAL ICONS CDN-->
...
<body>
    ...
    <main>
        ...
        <section class="middle">
            ...
            <?php
            $sql = "SELECT * FROM `printer_lists` WHERE id = $id LIMIT 1";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            ?>

            <div class="add_equipment_lampangcity">
                <div class="title">แก้ไขเลขครุภัณฑ์</div>
                <div class="content">
                    <form action="" method="post">
                        <div class="equipment_lampangcity">
                            <div class="column">
                                <div class="input-field">
                                    ...
                                    <label for="first_name">เลขครุภัณฑ์ปริ้นท์เตอร์</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="notification_message">
                            <p>
                                ...
                                กรอกเลขครุภัณฑ์ภัณฑ์ปริ้นท์เตอร์ ตัวอย่าง 416-41-4564.
                            </p>
                        </div>
                        ...
                        <div class="equipment_lampangcity" id="update_equipment">
                            ...
                            <div class="column">
                                ...
                                $printer_brand = "SELECT * FROM printer_brands";
                                $printer_brand_qry = mysqli_query($conn, $printer_brand);

                                ?>

                                <div class="select-box">
                                    <select class="form-select" id="printer_brand" name="printer_brand">
                                        <option selected disabled>เลือก แบรนด์เครื่องพิมพ์เอกสาร</option>
                                        <?php while ($printer_brand_row = mysqli_fetch_assoc($printer_brand_qry)): ?>
                                        <option value="<?php echo $printer_brand_row['id']; ?>" <?php if ($printer_brand_row['id'] == $row['printer_brand'])
                                               echo 'selected'; ?>>
                                            <?php echo $printer_brand_row['name']; ?>
                                        </option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                                <div class="select-box">
                                    <select class="form-select" id="printer_model" name="printer_model">
                                        ...
                                        if (!empty($row['printer_brand'])) {
                                            $printer_model_qry = mysqli_query($conn, "SELECT * FROM printer_models WHERE printer_brand_id = {$row['printer_brand']}");
                                            while ($printer_model_row = mysqli_fetch_assoc($printer_model_qry)): ?>
                                        <option value="<?php echo $printer_model_row['id']; ?>" <?php if ($printer_model_row['id'] == $row['printer_model'])
                                               echo 'selected'; ?>>
                                            <?php echo $printer_model_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="printer_type" name="printer_type">
                                        <option selected disabled>เลือก ประเภทเครื่องพิมพ์เอกสาร</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก computer_type แล้วหรือยัง
                                        if (!empty($row['printer_model'])) {
                                            $printer_type_qry = mysqli_query($conn, "SELECT * FROM printer_types WHERE printer_model_id = {$row['printer_model']}");
                                            while ($printer_type_row = mysqli_fetch_assoc($printer_type_qry)): ?>
                                        <option value="<?php echo $printer_type_row['id']; ?>" <?php if ($printer_type_row['id'] == $row['printer_type'])
                                               echo 'selected'; ?>>
                                            <?php echo $printer_type_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="printer_kind" name="printer_kind">
                                        <option selected disabled>เลือก ชนิดเครื่องพิมพ์เอกสาร</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก computer_type แล้วหรือยัง
                                        if (!empty($row['printer_type'])) {
                                            $printer_kind_qry = mysqli_query($conn, "SELECT * FROM printer_kinds WHERE printer_type_id = {$row['printer_type']}");
                                            while ($printer_kind_row = mysqli_fetch_assoc($printer_kind_qry)): ?>
                                        <option value="<?php echo $printer_kind_row['id']; ?>" <?php if ($printer_kind_row['id'] == $row['printer_kind'])
                                               echo 'selected'; ?>>
                                            <?php echo $printer_kind_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="connecting_printer" name="connecting_printer">
                                        <option selected disabled>เลือก การเชื่อมต่อเครื่องพิมพ์เอกสาร</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก computer_type แล้วหรือยัง
                                        if (!empty($row['printer_kind'])) {
                                            $connecting_printer_qry = mysqli_query($conn, "SELECT * FROM connecting_printers WHERE printer_kind_id = {$row['printer_kind']}");
                                            while ($connecting_printer_row = mysqli_fetch_assoc($connecting_printer_qry)): ?>
                                        <option value="<?php echo $connecting_printer_row['id']; ?>" <?php if ($connecting_printer_row['id'] == $row['connecting_printer'])
                                               echo 'selected'; ?>>
                                            <?php echo $connecting_printer_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="color_printing" name="color_printing">
                                        <option selected disabled>เลือก สีหมึกเครื่องพิมพ์เอกสาร</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก computer_type แล้วหรือยัง
                                        if (!empty($row['connecting_printer'])) {
                                            $color_printing_qry = mysqli_query($conn, "SELECT * FROM color_printings WHERE connecting_printer_id = {$row['connecting_printer']}");
                                            while ($color_printing_row = mysqli_fetch_assoc($color_printing_qry)): ?>
                                        <option value="<?php echo $color_printing_row['id']; ?>" <?php if ($color_printing_row['id'] == $row['color_printing'])
                                               echo 'selected'; ?>>
                                            <?php echo $color_printing_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                                ...
                                <div class="select-box">
                                    <select class="form-select" id="paper_size_printing" name="paper_size_printing">
                                        <option selected disabled>เลือก ขนาดกระดาษ</option>
                                        <?php
                                        // ตรวจสอบว่ามีการเลือก computer_type แล้วหรือยัง
                                        if (!empty($row['color_printing'])) {
                                            $paper_size_printing_qry = mysqli_query($conn, "SELECT * FROM paper_size_printings WHERE color_printing_id = {$row['color_printing']}");
                                            while ($paper_size_printing_row = mysqli_fetch_assoc($paper_size_printing_qry)): ?>
                                        <option value="<?php echo $paper_size_printing_row['id']; ?>" <?php if ($paper_size_printing_row['id'] == $row['paper_size_printing'])
                                               echo 'selected'; ?>>
                                            <?php echo $paper_size_printing_row['name']; ?>
                                        </option>
                                        <?php endwhile;
                                        }
                                        ?>
                        ...
                        <div class="department_lampangcity" id="update_department">
                            <div class="title">แก้ไขสถานะผู้ใช้</div>
                            <?php
                            ...
                            <div class="title">แก้ไขผู้ใช้งานครุภัณฑ์</div>
                            <div class="equipment_lampangcity">
                                <div class="column">
                                    <div class="input-field">
                                        <input type="text" name="owner_printer"
                                            value="<?php echo $row['owner_printer'] ?>" required />
                                        <label for="owner_printer">ชื่อผู้ใช้งานครุภัณฑ์เครื่งองพิมพ์เอกสาร</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="notification_message">
                                <p>
                                    <span class="material-icons-sharp">error</span>
                                    กรอกชื่อเจ้าของครุภัณฑ์ ตัวอย่าง นางสาวกุลภรณ์ ณฤดีวงศ์สกุล.
                                </p>
                            </div>
                            ...
                            <div class="wrapper">
                                <div class="btns">
                                    ...
                                    <div class="back_page">
                                        <div class="btn_back">
                                            <a href="../Equip_printer.php">ย้อนกลับ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
";
    ...
    <script src="../../../../assets/js/printer/db_printer.js"></script>
