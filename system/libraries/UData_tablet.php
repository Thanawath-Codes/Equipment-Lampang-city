...
?>
                ...
                <a href="../../application/controllers/user/search/Search_tablet.php">ค้นหาข้อมูล</a>     
            </div>
        </aside>
        <!------------------- END OF ASIDE ------------------->
        <section class="middle">
            ...
            <div class="wrapper">
                <div class="btns">
                    <a href="../../application/controllers/user/add/Add_tablet.php">เพิ่มข้อมูลผู้ใช้งาน</a>
    ...
    <div id="ups_list_container" class="data_equipment_tablet">
        ...
        <section class="right">
            <div class="investments">
                <div class="header">
                    <h2>แบรนด์แทบเล็ต</h2>
                    <a href="../../application/controllers/user/search/Search_tablet.php">เพิ่มเติม <span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
