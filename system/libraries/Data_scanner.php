...
?>
                ...
                <a href="../../application/controllers/admin/search/Search_scanner.php">ค้นหาข้อมูล</a>     
            </div>
        </aside>
        <!------------------- END OF ASIDE ------------------->
...
";
            ...
            <div class="recent-transactions">
                <div class="header">
                    ...
                    <a href="../../application/controllers/admin/Dashboard.php">เพิ่มเติม<span class="material-icons-sharp">
                            chevron_right
                        </span></a>
                </div>
